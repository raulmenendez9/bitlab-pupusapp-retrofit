...
class DetalleOrdeAdapter(var orden: List<Orden>, val listener: DetalleOrdeViewHolder.DetalleListener): RecyclerView.Adapter<DetalleOrdeViewHolder>(){
  ...
  override fun onBindViewHolder(holder: DetalleOrdeViewHolder, position: Int) {
    ...
    holder.detalleItems(orden[position])
  }
